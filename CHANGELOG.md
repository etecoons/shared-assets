...
shared-core    = { git = "https://github.com/etecoons/shared-assets", tag = "v3.0.0" }
shared-backend = { git = "https://github.com/etecoons/shared-assets", tag = "v3.0.0" }
shared-frontend = { git = "https://github.com/etecoons/shared-assets", tag = "v3.0.0" }
